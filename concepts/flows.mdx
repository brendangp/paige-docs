...
Flows are defined in JSON format (version `6.0`). Each Flow contains one or more screens, and each screen contains a layout of components. Paige's AI agent generates and edits this JSON for you — you rarely need to edit it by hand.
