...
<Steps>
  ...
  <Step title="Preview and validate">
    Use the Flow preview simulator in the Paige dashboard to step through the Flow screens. You can also ask the agent to validate the Flow and surface any Meta errors.
  </Step>
