...
| `Dropdown` | A single-select dropdown (up to 200 options) |
| `RadioButtonsGroup` | A single-select list of radio buttons (up to 20 options) |
| `CheckboxGroup` | A multi-select list of checkboxes (up to 20 options) |
