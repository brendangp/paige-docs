...
<CardGroup cols={2}>
  ...
  <Card title="Connectors" icon="plug" href="/integrations">
    Connections to Airtable, Slack and WordPress, so your bot can read and write there without you handling a token.
  </Card>
