...
You don't need code to send a template to one person. Open the [Conversations tab](/guides/conversations-tab#sending-a-template), pick the contact, and click **Send template** in the composer. Fill in any placeholders and send — this is how you reach someone whose 24-hour window has closed.
