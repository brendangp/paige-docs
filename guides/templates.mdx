...
<Tabs>
  ...
  <Tab title="Via the Broadcasting assistant">
    On the **Broadcasts** tab, the [Broadcasting assistant](/guides/broadcasts/broadcasting-assistant) can draft a template, show it to you, submit it once you're happy, and tell you when Meta has approved it — without leaving the campaign you're planning.
