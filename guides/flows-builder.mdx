...
<Info>
  For *when* to use a flow versus a plain back-and-forth — and what you trade away by choosing structure — see [Thinking in flows](/learn/thinking-in-flows). This page is the hands-on how-to.
</Info>
