...
Each of these is a full tab on the desktop, with its own page: the [Preview panel](/guides/preview-tab), the [Conversations inbox](/guides/conversations-tab), and [Settings](/guides/settings-tab).
