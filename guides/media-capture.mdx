...
<AccordionGroup>
  <Accordion title="Off — don't save anything (the default)" icon="ban">
  ...
  <Accordion title="Save from Conversations — save individual files by hand" icon="hand">
  ...
  <Accordion title="Save all — save every inbound file automatically" icon="save-all">
  ...
  <Accordion title="Selective — let your bot decide what's worth keeping" icon="filter">
