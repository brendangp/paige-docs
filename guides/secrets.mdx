...
<Tip>
  For **Airtable** and **Slack**, don't store a raw token here — use [Connectors](/guides/connectors) instead. Connectors handle the sign-in for you and keep the credential out of your hands entirely. Secrets are the right tool for everything else.
</Tip>
