...
<PageDemo src="/assets/videos/logs.mp4" poster="/assets/videos/logs.poster.jpg" />
...
<AccordionGroup>
  <Accordion title="log — General output" icon="scroll-text">
  ...
  <Accordion title="error — Errors and failures" icon="circle-x">
  ...
  <Accordion title="warn — Warnings and unexpected conditions" icon="triangle-alert">
  ...
  <Accordion title="info — Informational milestones" icon="info">
