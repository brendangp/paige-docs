...
**Settings → API** is a separate section, for giving other apps and AI agents programmatic access to the project. It's where you create Paige API keys and connect an agent like Claude, ChatGPT, or Codex — including attaching several projects to one connection. It's visible to owners and admins only. See [Connect an AI agent](/guides/connect-an-agent).
