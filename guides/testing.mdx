...
If you're working with the AI agent to build or modify your bot, you can ask it to run a simulated test using the built-in `test_bot` tool. This lets the AI send a message to your bot programmatically and observe the response — without you needing to pick up your phone.

To trigger a programmatic test, describe the scenario you want to test in the AI agent chat. For example:
