...
<CardGroup cols={2}>
  ...
  <Card title="Flows" icon="workflow">
    Build, update, validate, publish, and upload [WhatsApp Flows](/guides/flows/overview), and embed images into flow screens.
  </Card>
