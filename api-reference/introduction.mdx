...
Everything you do in the Paige dashboard, your own code can do too. The **Paige API** is a plain REST API over HTTPS: send a WhatsApp message, read a conversation, update a contact's tags, create a template, assemble a broadcast, edit your bot's code, deploy, or register a webhook.
