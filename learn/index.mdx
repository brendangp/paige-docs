...
- **When templates come in** — why some messages need Meta's approval, and the 24-hour window that forces it.
...
<CardGroup cols={2}>
  ...
  <Card title="Understanding templates" icon="file-text" href="/learn/understanding-templates">
    Why WhatsApp makes you get messages approved, the 24-hour window, and template versus free-form reply.
  </Card>
