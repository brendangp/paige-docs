...
This page is about that thinking. It's not about the buttons in the builder — for how to actually create, preview, and publish flows in Paige, see **[Flows](/guides/flows/overview)**. Here we're one level up: how to decide what the conversation should look like before you build it.
...
<CardGroup cols={2}>
  <Card title="Flows" icon="wrench" href="/guides/flows/overview">
