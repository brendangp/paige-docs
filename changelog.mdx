...
- **Send a test template to your Paige Dev tester.** The Paige Dev card has a new **Send test template** button that delivers a pre-built Meta template — with an embedded flow-trigger button — to your linked phone in one click. Rate-limited to 5 successful sends per linked number per rolling 24 hours. See [Send a test template](/guides/testing#send-a-test-template-to-your-linked-phone).
