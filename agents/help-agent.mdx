...
The Help Agent is your in-app guide to Paige. While the [Code Agent](/agents/code-agent) builds your bot for you and [the AI inside your bot](/agents/conversational-agent) talks to your customers, the Help Agent is there to help **you** — the builder — figure out the platform itself.
